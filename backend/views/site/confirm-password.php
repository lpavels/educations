...
<div class="div-window site-confirm-password">
    <div class="row">
        ...
        <div class="logo-text col-10">
            ...
            <p class="mt-3"><?= ($flash['success2']) ? 'На электронную почту '.$hideEmail.' отправлена инструкция по изменению пароля.':(($flash['warning']) ? 'Ссылка недействительна' : (($flash['success']) ? 'Пароль изменен, теперь вы можете авторизоваться для выбора программ обучения.' : 'Перейдите повторно по ссылке в электронной почте. Если проблема сохраняется напишите в техническую поддержку (' . Yii::$app->params['supportEmail'] . '). '));?></p>
        </div>
    </div>
</div>
